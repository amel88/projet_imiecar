...
class VilleController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $villes = $em->getRepository('ImiecarBundle:Ville')->findAll();
    ...
    {
        $ville = new Ville();
        $form = $this->createForm('ImiecarBundle\Form\VilleType', $ville);
    ...
    {
        $deleteForm = $this->createDeleteForm($ville);
        $editForm = $this->createForm('ImiecarBundle\Form\VilleType', $ville);
